...
public interface UpdateEstablishment {
  void update(String id, String cnpj, String name, Address address, String phone, Integer numberOfSpaceMotorcycles, Integer numberOfSpaceCars) throws Exception;
